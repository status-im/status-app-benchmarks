...
class SiteNavigationTests(unittest.TestCase):
    ...
    def test_send_timing_table_uses_latest_summaries(self):
        ...
        self.assertIn('href="fresh-profile.html#test_group_chat_plain_text_visible_time"', html)
        self.assertNotIn('href="fresh-profile.html#test_group_chat_plain_text_sent_time"', html)
