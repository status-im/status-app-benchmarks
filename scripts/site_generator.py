...
def write_site(
    ...
    *,
    ...
    index_body = (
        ...
        'Each point is one nightly run — x-axis shows date and commit; hover for full build hash.</p>'
        f'{summary}'
        '<h2 style="margin-top:2rem">Scenarios</h2>'
        f'<div class="grid">{cards}</div>'
        '<p class="note">Raw CSV history lives in the repository <code>data/</code> folder.</p>'
    )
